...
PAGES = [
    ...
    dict(src=M + 'c4270276-Contact.dc.html', out=R + 'contact/index.html',
         ...
         desc="Parlons de votre projet. Un seul interlocuteur, celui qui fera le "
              "travail. Reponse sous vingt-quatre heures."),
    dict(src=M + '7cca7f16-Automatisations.dc.html', out=R + 'automatisations/index.html',
         ...
         desc="Page en cours de redesign. Les automatisations et les agents sont "
              "presentes sur la page d'accueil.",
         noindex=True),
]
